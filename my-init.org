...
#+begin_src emacs-lisp
  (use-package google-translate
    :ensure t
    :config
    :custom (google-translate-default-target-language "ru")
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq default-frame-alist '((font . "-xos4-terminus-medium-r-normal--14-*-72-72-c-80-iso10646-1")))
...
#+END_SRC
* non-elpa
* not using for some reason
** no-easy-keys
   Force to use right key in emacs (no arrows / Delete / Home / etc)
   Already made me to not use those keys.
  #+begin_src emacs-lisp
