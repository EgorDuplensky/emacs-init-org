...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key global-map [f1] '(lambda ()  (interactive) (or (when (get-buffer "*ansi-term*") (switch-to-buffer "*ansi-term*")) (when (get-buffer "E2C") (switch-to-buffer "E2C"))) (delete-other-windows)))
  (define-key global-map [f2] '(lambda ()  (interactive) (or (when (get-buffer "*10.210.140.220*") (switch-to-buffer "*10.210.140.220*")) (when (get-buffer "dev-machine") (switch-to-buffer "dev-machine"))) (delete-other-windows)))
...
#+BEGIN_SRC emacs-lisp
  (use-package ejira
    ...
    :ensure nil
    :init
    (setq jiralib2-url "jira.tietoenator.extern.sw.ericsson.se"
          jiralib2-user-login-name "xxduplee"
          )
    )
#+END_SRC
** ox-pandoc
